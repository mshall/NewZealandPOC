...
public class ShopsController {
	...
	public ResponseEntity<ShopsResponse> findShopsByPostCode(@RequestParam(value="town", required = false) String town,
			@RequestParam(value = "postcode", required = false) String postcode) {
		ShopsResponse shops = service.getShopsByPostcodeAndTown(postcode, town);
